...
<%
    ...
    {
        String Ename=request.getParameter("txt_Employed");
        if(!request.getParameter("hiddenid").equals(""))
        {
            int rid=Integer.parseInt(request.getParameter("hiddenid"));
            obb.executeCommand("update tbl_employed set Employed_in='"+Ename+"' where emp_id='"+rid+"'");
        }
        else
        {
        obb.executeCommand("insert into tbl_employed(Employed_in) values('"+Ename+"')");
                }
    ...
    if(request.getParameter("del")!=null)
    {
      ...
      obb.executeCommand("delete from tbl_employed where emp_id='"+eid+"'");
    }
    
    if(request.getParameter("edit")!=null)
    {
       String eid1=request.getParameter("edit");
       ResultSet rs1=obb.selectData("select * from tbl_employed where emp_id='"+eid1+"'");
       while(rs1.next())
       {
       EmpName=rs1.getString("Employed_in");
...
.button_link.cancel
{
    ...
    <body>
        ...
        <form class="Malayali_campaignrightthree">
            ...
            <input type="hidden" name="hiddenid" value="<%=Empid%>">
            ...
            <div class="ReligionForm_details">
                <div class="registerhead"><label style="color: #ff0033">Employed Entry</label></div>
                <table>
                    <tr>
                        <td><div class="Religion_innerregisterform_new" ><label class="religionlabel">Employed In</label></div></td><td><div class="Religion_innerregisterform_new"><input type="text" name="txt_Employed" placeholder="Enter Employed in" class="regtxtbox" value="<%=EmpName%>"></div></td>
                    </tr>
                ...
                <!--table searching start here-->
                 ...
                 <div class="Religion_innerregisterform_table">
                     ...
                     <table id="myTable" >
                             ...
                             <tr>
                                <td>
                                    <%=rs.getString("Employed_in") %>
                                </td>
                               
                                <td>
                                    <a href="Employed.jsp?edit=<%=rs.getString("emp_id")%>"><input type="button" class="button_link" value="edit">
                                    </a>
                                </td>
                                <td>
                                    <a href="Employed.jsp?del=<%=rs.getString("emp_id")%>"><input type="button" class="button_link cancel" value="delete"></a>
                                </td>
