  ...
  margin-bottom: 12px;
    ...
    <body>
        ...
        <form class="Malayali_campaignrightthree">
            ...
            <div class="MalyaliMarriage_logo1"><img src="img/Bride-and-groom-wedding-congratulations(2).png" alt="MalayaliMarriage" title="MalayaliMarriage" width="181" height="80"></div>
            ...
            <div class="ReligionForm_details">
                ...
                <table>
                    <tr>
                        <td><div class="Religion_innerregisterform_new" ><label class="religionlabel">Religion</label></div></td><td><div class="Religion_innerregisterform_new"><input type="text" name="txt_religion" placeholder="Enter Religion" class="regtxtbox"></div></td>
                    </tr>
